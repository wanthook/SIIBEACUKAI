...
//                print_r($arrD);
                ...
                $arrD['mark']                   = (!empty(trim($arrS['S']))?trim($arrS['S']):'');
    ...
    private function insert_pemakaian_subkontrak($arr,$uploadId)
    {
        ...
        foreach($arr as $arrS)
        {
            if($i>=6)
            {
                ...
                $arrD['mark']                   = (!empty(trim($arrS['K']))?trim($arrS['K']):'');
...
//                            );
//                            
//                            $this->Mod_pemakaiansubkontrak->update_master($arrUpd,array('field'=>'pemakaianbahanbaku_id','value'=>$res->pemakaianbahanbaku_id));
//                        }
//                        
//                        continue;
//                    }
    ...
    private function insert_pemasukan_hasil_produksi($arr,$uploadId)
    {
        ...
        foreach($arr as $arrS)
        {
            if($i>=6)
            {
                ...
                $arrD['mark']                   = (!empty(trim($arrS['L']))?trim($arrS['L']):'');
    ...
    private function insert_pengeluaran_hasil_produksi($arr,$uploadId)
    {
        ...
        foreach($arr as $arrS)
        {
            if($i>=6)
            {
                ...
                $arrD['mark']                   = (!empty(trim($arrS['T']))?trim($arrS['T']):'');
        ...
        foreach($arr as $arrS)
        {
            if($i>=6)
            {
                ...
                if($rowCrc->num_rows()>0)
                {
                    ...
                    if($arrD['mark']==$res->mark && empty($arrD['nomor']))
                    {
                        continue;
                    }
                    else
