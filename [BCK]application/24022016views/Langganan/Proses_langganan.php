...
<!--                            <li>
                    ...
                    <h4 class="widgettitle">Tabel Langganan</h4>
                    <table id="tableId" class="table table-bordered responsive">
                        ...
                        <thead>
                            <tr>
                                <th class="head0">&nbsp;</th>
                                <th class="head1">Kode Pelanggan</th>
                                <th class="head0">Nama Depan</th>
                                <th class="head1">Nama PT</th>
                                <th class="head0">Alamat</th>
                                <th class="head1">Kota</th>
                                <th class="head0">Kode Pos</th>
                                <th class="head1">Telpon</th>
                                <th class="head0">No. HP</th>
                                <th class="head1">Fax</th>
                                <th class="head0">Nama Orang</th>
                                <th class="head1">No. Identitas</th>
                                <th class="head0">PKP</th>
                                <th class="head1">No. NPWP</th>
                            </tr>
                        </thead>
                    </table>
                </div>
