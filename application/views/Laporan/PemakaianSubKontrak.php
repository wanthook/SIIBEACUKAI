...
$controller = "PemakaianSubKontrak";
...
?>
    ...
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li>Pemakaian Barang Dalam Proses Dalam Rangka Kegiatan Subkontrak</li>            
        </ul><!-- END NAVIGATOR -->
...
<!--                            <li>
                    ...
                    <h4 class="widgettitle">Tabel Pemakaian Barang Dalam Proses Dalam Rangka Kegiatan Subkontrak</h4>
                    <table class="table">
                        <thead>
                        <tr>
                        <form id="frmSearch">
                    ...
                    <table id="tableId" class="table table-bordered responsive">
                        <?php
                        $arrHead = array('No. Pabean','No. Bukti Pengeluaran Barang',
