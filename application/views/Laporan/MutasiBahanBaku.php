...
<!--                            <li>
                    ...
                    <h4 class="widgettitle">Tabel Mutasi Bahan Baku</h4>
                    <table class="table">
                        <thead>
                        <tr>
                        <form id="frmSearch">
...
//        jQuery('#tableId_length').html("Bla");
        ...
        table = jQuery('#tableId').DataTable( {
            ...
            [  
                ...
                { "data": "batch" },
                { "data": "satuan" },
                { "data": "saldo_awal" },								{ "data": "lbsSaldo_awal" },
                { "data": "pemasukan" },								{ "data": "lbsPemasukan" },
                { "data": "pengeluaran" },								{ "data": "lbsPengeluaran" },
                { "data": "saldo_akhir" },								{ "data": "lbsSaldo_akhir" },
                { "data": "gudang" }
