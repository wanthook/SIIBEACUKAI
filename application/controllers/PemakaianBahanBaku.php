...
class PemakaianBahanBaku extends Secure_area
{
    ...
    function pdf()
    {
        ...
        $tabel .= '<tr>      
                   ...
                   <th>Nomor</th>
                   <th>Tanggal</th>
                   <th>Digunakan</th>				   				   <th>Digunakan (LBS)</th>
        ...
        if($data->num_rows()>0)
        {
            ...
            foreach ($res as $dataKey => $dataValue)
            {
                ...
                $tabel .= '<td>'.$dataValue->digunakan.'</td>';								$tabel .= '<td>'.$dataValue->digunakan_lbs.'</td>';
...
//        write_file('./report/output.pdf', $fl);
    ...
    {        
		...
		'No. Pabean',
                   ...
                   'Batch',
                   'Satuan',
                   'Jumlah Digunakan',				   				   'Jumlah Digunakan (LBS)',
        ...
        if($data->num_rows()>0)
        {
            ...
            foreach ($res as $dataKey => $dataValue)
            {
                ...
                $table[]    = array(
                    ...
                    $dataValue->batch,
                    $dataValue->satuan,
                    $dataValue->digunakan,										$dataValue->digunakan_lbs,
        ...
        $ret    = array(
            'laporan'           => "Laporan Pemakaian Bahan Baku",
            'tanggal_awal'      => $sD,
            'tanggal_akhir'     => $eD,
            'head'              => $head,
            'table'             => $table
